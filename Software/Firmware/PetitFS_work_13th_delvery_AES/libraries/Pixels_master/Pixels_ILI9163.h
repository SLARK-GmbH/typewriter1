...
public:
	...
	//setSpiPins(SCK, SDA, TFT_CS, TFT_RST);
	//setSpiPins(15,16,8,10);
	setSpiPins(0,0,TFT_CS,TFT_RST);
...
/***********************************************************************************
**	borrowed from TFT_ILI9163.h	start
***********************************************************************************/
...
***************************************************************************************/
void Pixels::commandList (const uint8_t *addr)
{
