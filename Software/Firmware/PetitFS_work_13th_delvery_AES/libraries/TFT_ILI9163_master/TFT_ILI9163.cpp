...
***************************************************************************************/
void TFT_ILI9163::writecommand(uint8_t c)
{
  TFT_DC_C;
  TFT_CS_L;
  spiwrite(c);
...
***************************************************************************************/
void TFT_ILI9163::writedata(uint8_t c)
{
  TFT_DC_D;
  TFT_CS_L;
  spiwrite(c);
...
***************************************************************************************/
void TFT_ILI9163::commandList (const uint8_t *addr)
{
...
***************************************************************************************/
void TFT_ILI9163::setTextSize(uint8_t s)
{
...
***************************************************************************************/
void TFT_ILI9163::setTextFont(uint8_t f)
{
...
***************************************************************************************/
void TFT_ILI9163::setTextColor(uint16_t c)
{
...
***************************************************************************************/
void TFT_ILI9163::setTextColor(uint16_t c, uint16_t b)
{
  textcolor   = c;
  textbgcolor = b;
}
...
***************************************************************************************/
void TFT_ILI9163::setTextWrap(boolean w)
{
  textwrap = w;
}
...
***************************************************************************************/
void TFT_ILI9163::setTextDatum(uint8_t d)
{
  textdatum = d;
}
...
***************************************************************************************/
void TFT_ILI9163::setTextPadding(uint16_t x_width)
{
  padX = x_width;
}
...
***************************************************************************************/
uint8_t TFT_ILI9163::getRotation(void)
{
  return rotation;
}
...
int16_t TFT_ILI9163::width(void)
{
  return _width;
}
...
***************************************************************************************/
int16_t TFT_ILI9163::height(void)
{
  return _height;
}
...
***************************************************************************************/
int16_t TFT_ILI9163::textWidth(char *string, int font)
{
...
uint16_t TFT_ILI9163::fontsLoaded(void)
{
  return fontsloaded;
}
...
***************************************************************************************/
int16_t TFT_ILI9163::fontHeight(int font)
{
...
void TFT_ILI9163::fastSetup(void)
{
  spi_begin();
...
***************************************************************************************/
void TFT_ILI9163::pushColor(uint16_t color, uint16_t len)
{
  spi_begin();
...
void TFT_ILI9163::pushColors(uint16_t *data, uint8_t len)
{
  uint16_t color;
  spi_begin();
...
void TFT_ILI9163::pushColors(uint8_t *data, uint16_t len)
{
  spi_begin();
  len = len<<1;
...
***************************************************************************************/
uint16_t TFT_ILI9163::color565(uint8_t r, uint8_t g, uint8_t b)
{
...
void TFT_ILI9163::setRotation(uint8_t m)
{
...
***************************************************************************************/
void TFT_ILI9163::invertDisplay(boolean i)
{
  spi_begin();
...
Scroll (actually frame roll) functions added by MJS.

*/

int TFT_ILI9163::setScrollWindow(uint8_t TopFixHeight, uint8_t BotFixHeight)
{

	

/* 
Might be worth investigating if we can make use of the unused part of the framebuffer ram to scroll/render offscreen.

... may have to set the chip to 132 x 162 mode to enable the extra ram which would only give us 2 extra lines - If the screen could  be got to work in the wrong mode */

// Calculate VScroll height.

int VScrollHeight = ILI9163_TFTHEIGHT - TopFixHeight - BotFixHeight;
	...
	writedata(0x00);
	writedata(TopFixHeight);


	// Vertical Scroll Area 
	
	writedata(0x00);
	writedata(VScrollHeight);


	// Bottom Fixed Area

	writedata(0x00);
	writedata(BotFixHeight);


	return VScrollHeight;
}

void TFT_ILI9163::vScroll(uint8_t vsp) {
...
void TFT_ILI9163::exitScrollMode()  {
	
	writecommand(ILI9163_DISPOFF);
	writecommand(ILI9163_NORON);		//normal mode on
...
***************************************************************************************/
size_t TFT_ILI9163::write(uint8_t uniCode)
{
