...
void 	writeGRAM(int16_t x, int16_t y, uint16_t * block, int16_t w, int16_t h);
void	writeGRAM_1(int16_t x, int16_t y, uint16_t * block, int16_t w, int16_t h);
...
protected:
	...
	inline __attribute__((always_inline))
		void write_cont(uint8_t* buf, uint32_t n) {
#if SPI_MODE_DMA
		dmaSend(buf, n);
#endif
	}
