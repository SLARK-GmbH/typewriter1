...
// These calibration settings works with my TFTM022-1
// They MIGHT work on your display module, but you should run the
// calibration sketch anyway


#define CAL_X 0x0047CE5CUL  //ER-TFTM022-1 
#define CAL_Y 0x00330EBCUL  //ER-TFTM022-1
#define CAL_S 0x000EF13FUL  //ER-TFTM022-1
